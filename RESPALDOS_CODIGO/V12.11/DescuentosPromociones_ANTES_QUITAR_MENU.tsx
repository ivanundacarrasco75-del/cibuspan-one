...
export default function DescuentosPromociones({ cambiarPantalla }: Props) {
  const hoy = fechaIso()
  ...
  return (
    <main className="discounts-page">
      ...
      <nav className="sales-tabs" aria-label="Módulos de ventas">
        <button type="button" onClick={() => cambiarPantalla("Ventas")}>Ventas</button>
        <button type="button" onClick={() => cambiarPantalla("Reporte de devoluciones")}>Devoluciones</button>
        <button type="button" className="active">Descuentos y promociones</button>
      </nav>
