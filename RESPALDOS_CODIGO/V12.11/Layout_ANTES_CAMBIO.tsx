...
const modulos: Modulo[] = [
  ...
  },
  {
    ...
    etiqueta: "Comercial",
    icono: "comercial",
    entrada: "Comercial · Resumen",
    items: [
      { pantalla: "Comercial · Resumen", etiqueta: "Resumen" },
      ...
      { pantalla: "Comercial · Clientes", etiqueta: "Clientes" },
      { pantalla: "Comercial · SKU", etiqueta: "SKU" },
    ],
  },
  {
    id: "Producción",
    ...
    <div className="c1-shell">
      ...
      <nav className="c1-bottom-nav" aria-label="Navegación móvil">
        ...
        <BotonInferior
          ...
          etiqueta="Comercial"
          icono="comercial"
          onClick={() => navegar("Comercial · Resumen")}
        />
        <BotonInferior
