...
export default function VentasClienteSku({
  ...
  return (
    <main className="c1-ventas" style={pagina}>
      ...
      <nav className="ventas-main-tabs" aria-label="Módulos de ventas">
        <button type="button" className="active">
          Ventas
        </button>
        <button
          type="button"
          onClick={() => cambiarPantalla("Reporte de devoluciones")}
        >
          Devoluciones
        </button>
        <button
          type="button"
          onClick={() => cambiarPantalla("Descuentos y promociones")}
        >
