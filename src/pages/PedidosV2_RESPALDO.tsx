...
export default function PedidosV2() {
  ...
  const pedidosOrdenados = useMemo(() => {
    return [...pedidos].sort((a, b) => {
      ...
      return b.creado_en.localeCompare(
        a.creado_en,
      )
    })
  }, [pedidos])
...
const pedidosResponsiveCss = `
  ...
  .c1-orders .orders-panel h2,
  .c1-orders .orders-import h2 {
    color: #4f2728;
  }
  ...
  @media (max-width: 760px) {
    ...
    .c1-orders .orders-panel-title p {
      font-size: 11px !important;
    }
    ...
    .c1-orders .orders-form label {
      font-size: 11px !important;
    }

    .c1-orders .orders-form input,
    .c1-orders .orders-form select {
      min-height: 43px !important;
      font-size: 14px;
    }

    /* Productos: tabla convertida en tarjetas, sin scroll horizontal. */
    ...
    .c1-orders .orders-products-table td:nth-child(1) {
    ...
    .c1-orders .orders-products-table td:nth-child(1)::before {
      display: none;
    }

    .c1-orders .orders-products-table td:nth-child(1) strong {
      color: var(--c1-vino);
      font-size: 15px;
    }

    .c1-orders .orders-products-table td:nth-child(1) small {
      display: block;
      margin-top: 2px;
      color: #8b7b75;
      white-space: normal;
    ...
    .c1-orders .orders-summary span {
      font-size: 9px !important;
    }

    .c1-orders .orders-summary strong {
    ...
    .c1-orders .orders-save-panel > div {
      text-align: center;
    }

    .c1-orders .orders-save-panel strong {
    ...
    /* Pedidos registrados: cada pedido es una tarjeta. */
    ...
    .c1-orders .orders-registered-table td:nth-child(1)::before { content: "Pedido"; }
    .c1-orders .orders-registered-table td:nth-child(2)::before { content: "Registro"; }
    .c1-orders .orders-registered-table td:nth-child(3)::before { content: "Cliente"; }
    .c1-orders .orders-registered-table td:nth-child(4)::before { content: "Bodega"; }
    .c1-orders .orders-registered-table td:nth-child(5)::before { content: "Entrega"; }
    .c1-orders .orders-registered-table td:nth-child(6)::before { content: "Prioridad"; }
    .c1-orders .orders-registered-table td:nth-child(7)::before { content: "Estado"; }
    .c1-orders .orders-registered-table td:nth-child(8)::before { content: "Unidades"; }
    .c1-orders .orders-registered-table td:nth-child(9)::before { content: "Acciones"; }

    .c1-orders .orders-registered-table td:first-child strong {
      color: var(--c1-vino);
      font-size: 15px;
    }

    .c1-orders .orders-registered-table td:nth-child(2) small {
      display: block;
      max-width: 190px;
      overflow: hidden;
    ...
    /* Modal de pedido en pantalla completa. */
    ...
    .c1-orders .orders-modal-kpis > div {
      min-width: 0;
      padding: 10px !important;
    }

    .c1-orders .orders-modal-kpis span {
      font-size: 9px !important;
    }

    .c1-orders .orders-modal-kpis strong {
      font-size: 12px;
      overflow-wrap: anywhere;
    }
    ...
    .c1-orders .orders-detail-table td:nth-child(1) strong {
      color: var(--c1-vino);
    }
    ...
    .c1-orders .orders-modal-summary > div {
      text-align: center;
      min-width: 0;
    }

    .c1-orders .orders-modal-summary span {
      font-size: 9px !important;
    }

    .c1-orders .orders-modal-summary strong {
      font-size: 18px !important;
    }
  }
`