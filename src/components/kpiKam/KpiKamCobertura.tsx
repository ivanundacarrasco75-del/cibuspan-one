...
.cob-matriz-panel{border:1px solid #e2d6d0;border-radius:14px;background:#fff;overflow:hidden}.cob-matriz-head{display:flex;justify-content:space-between;align-items:center;gap:16px;padding:15px 16px}.cob-matriz-head>div:first-child>span{display:block;color:#f28c18;font-size:10px;font-weight:900;letter-spacing:.09em}.cob-matriz-head h3{margin:3px 0;color:#8f1d24;font-size:20px}.cob-matriz-head p{margin:0;color:#7d6f69;font-size:12px}.cob-matriz-filtros{display:flex;gap:7px}.cob-matriz-filtros input{min-width:175px}.cob-matriz-filtros select{max-width:175px}.cob-leyenda{display:flex;gap:18px;flex-wrap:wrap;padding:10px 16px;border-top:1px solid #eee4de;background:#faf8f6;color:#70635e;font-size:11px}.cob-leyenda span{display:flex;align-items:center;gap:7px}.cob-leyenda i{display:inline-grid;place-items:center;width:22px;height:22px;border-radius:6px;font-style:normal;font-size:15px;font-weight:900}.cob-leyenda .verde{color:#148248;background:#e8f7ee}.cob-leyenda .gris{color:#9b8e88;background:#f0ece9}.cob-leyenda .naranja{color:#b2680c;background:#fff1da}.cob-leyenda .rojo{color:#ad2630;background:#fdebed}.cob-matriz-scroll{max-height:64vh;overflow:auto;border-top:1px solid #eee4de;border-bottom:1px solid #eee4de}.cob-matriz-scroll table{width:100%;border-collapse:separate;border-spacing:0;table-layout:fixed}.cob-matriz-scroll th,.cob-matriz-scroll td{height:58px;padding:7px;border-right:1px solid #e4d8d2;border-bottom:1px solid #e4d8d2;text-align:center}.cob-matriz-scroll thead th{position:sticky;top:0;z-index:3;height:78px;background:#f6f1ee;color:#6b5b55}.cob-matriz-scroll thead th strong,.cob-matriz-scroll thead th small{display:block;overflow:hidden;text-overflow:ellipsis}.cob-matriz-scroll thead th strong{font-size:10px;line-height:1.25;text-transform:uppercase;white-space:normal}.cob-matriz-scroll thead th small{margin-top:6px;color:#8d7e78;font-size:9px;white-space:nowrap}.cob-matriz-scroll .local-col{position:sticky;left:0;width:250px;z-index:2;text-align:left;padding-left:14px;background:#fff}.cob-matriz-scroll thead .local-col{z-index:4;background:#f6f1ee;font-size:11px;text-transform:uppercase}.cob-matriz-scroll tbody .local-col strong,.cob-matriz-scroll tbody .local-col span{display:block}.cob-matriz-scroll tbody .local-col strong{color:#8f1d24;font-size:12px}.cob-matriz-scroll tbody .local-col span{margin-top:4px;color:#4e413d;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.cobertura-kam button.cob-celda{display:inline-grid;place-items:center;width:34px;height:34px;padding:0;border-radius:9px;font-size:19px;font-weight:900;line-height:1;transition:transform .12s ease,box-shadow .12s ease}.cobertura-kam button.cob-celda:hover{transform:scale(1.08);box-shadow:0 3px 9px rgba(68,40,34,.14)}.cobertura-kam button.cob-celda.activa{color:#148248;background:#e8f7ee}.cobertura-kam button.cob-celda.sin-cobertura{color:#9b8e88;background:#f0ece9}.cobertura-kam button.cob-celda.pendiente{color:#b2680c;background:#fff1da}.cobertura-kam button.cob-celda.alerta,.cobertura-kam button.cob-celda.inactiva{color:#ad2630;background:#fdebed}.cob-matriz-panel>footer{display:flex;justify-content:space-between;padding:10px 16px;color:#81736d;font-size:10px}
...
.cob-matriz-scroll td.cob-celda-fondo{height:58px;padding:0;transition:background-color .15s ease}.cob-matriz-scroll td.cob-celda-fondo.activa{background-color:#ccefdc}.cob-matriz-scroll td.cob-celda-fondo.sin-cobertura{background-color:#e8e2de}.cob-matriz-scroll td.cob-celda-fondo.pendiente{background-color:#ffe2ad}.cob-matriz-scroll td.cob-celda-fondo.alerta,.cob-matriz-scroll td.cob-celda-fondo.inactiva{background-color:#f8cdd2}.cobertura-kam select.cob-celda-select{display:block;width:100%;min-width:112px;height:58px;min-height:58px;padding:6px 24px 6px 8px;border:0;border-radius:0;font-size:11px;font-weight:900;line-height:1.2;text-align:center;text-transform:uppercase;cursor:pointer}.cob-celda-fondo.activa select.cob-celda-select{color:#0c6737!important;background-color:#ccefdc!important;-webkit-text-fill-color:#0c6737!important}.cob-celda-fondo.sin-cobertura select.cob-celda-select{color:#655954!important;background-color:#e8e2de!important;-webkit-text-fill-color:#655954!important}.cob-celda-fondo.pendiente select.cob-celda-select{color:#8d4e00!important;background-color:#ffe2ad!important;-webkit-text-fill-color:#8d4e00!important}.cob-celda-fondo.alerta select.cob-celda-select,.cob-celda-fondo.inactiva select.cob-celda-select{color:#8f1720!important;background-color:#f8cdd2!important;-webkit-text-fill-color:#8f1720!important}.cobertura-kam select.cob-celda-select:focus{outline:3px solid rgba(153,31,40,.3);outline-offset:-3px}.cobertura-kam select.cob-celda-select:disabled{opacity:.68;cursor:wait}
`
