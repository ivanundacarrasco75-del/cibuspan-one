...
.cob-matriz-scroll td.cob-celda-fondo{height:58px;padding:0;transition:background-color .15s ease}.cob-matriz-scroll td.cob-celda-fondo.activa{background-color:#ccefdc}.cob-matriz-scroll td.cob-celda-fondo.sin-cobertura{background-color:#e8e2de}.cob-matriz-scroll td.cob-celda-fondo.pendiente{background-color:#ffe2ad}.cob-matriz-scroll td.cob-celda-fondo.alerta,.cob-matriz-scroll td.cob-celda-fondo.inactiva{background-color:#f8cdd2}.cobertura-kam select.cob-celda-select{display:block;width:100%;min-width:112px;height:58px;min-height:58px;padding:6px 24px 6px 8px;border:0;border-radius:0;color:#4f403b;font-size:11px;font-weight:900;line-height:1.2;text-align:center;text-transform:uppercase;cursor:pointer}.cob-celda-fondo.activa select.cob-celda-select{color:#0c6737;background-color:#ccefdc}.cob-celda-fondo.sin-cobertura select.cob-celda-select{color:#655954;background-color:#e8e2de}.cob-celda-fondo.pendiente select.cob-celda-select{color:#8d4e00;background-color:#ffe2ad}.cob-celda-fondo.alerta select.cob-celda-select,.cob-celda-fondo.inactiva select.cob-celda-select{color:#8f1720;background-color:#f8cdd2}.cobertura-kam select.cob-celda-select:focus{outline:3px solid rgba(153,31,40,.3);outline-offset:-3px}.cobertura-kam select.cob-celda-select:disabled{opacity:.68;cursor:wait}
`
