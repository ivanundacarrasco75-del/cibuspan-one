...
.cob-matriz-scroll td.cob-celda-fondo{padding:0;transition:background-color .15s ease}.cob-matriz-scroll td.cob-celda-fondo.activa{background:#dff5e8}.cob-matriz-scroll td.cob-celda-fondo.sin-cobertura{background:#efebe8}.cob-matriz-scroll td.cob-celda-fondo.pendiente{background:#ffedcf}.cob-matriz-scroll td.cob-celda-fondo.alerta,.cob-matriz-scroll td.cob-celda-fondo.inactiva{background:#fbdfe2}.cobertura-kam select.cob-celda-select{width:100%;min-width:112px;height:48px;padding:4px 22px 4px 8px;border:0;border-radius:0;background:transparent;color:#4f403b;font-size:8px;font-weight:900;text-align:center;text-transform:uppercase;cursor:pointer}.cob-celda-fondo.activa select.cob-celda-select{color:#126f3e}.cob-celda-fondo.sin-cobertura select.cob-celda-select{color:#766a65}.cob-celda-fondo.pendiente select.cob-celda-select{color:#995907}.cob-celda-fondo.alerta select.cob-celda-select,.cob-celda-fondo.inactiva select.cob-celda-select{color:#9d2029}.cobertura-kam select.cob-celda-select:focus{outline:3px solid rgba(153,31,40,.22);outline-offset:-3px}.cobertura-kam select.cob-celda-select:disabled{opacity:.62;cursor:wait}
`
